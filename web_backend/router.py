...
from web_backend.services import (
    ToolAccessService,
    SystemService,
    EvidenceService,
    ReportService,
...
# Service instances for Tool Access, Evidence, Report, and Upload Subsystems
...
# =============================================================================
# KUSHAGRA BACKEND VERTICAL — PHASE 1: TOOL ACCESS LAYER & SYSTEM STATUS
# =============================================================================

@router.get("/system/status", tags=["System Diagnostics"])
async def get_system_status(
    db: AsyncSession = Depends(get_db),
    orchestrator: InvestigationOrchestrator = Depends(get_orchestrator)
):
    """
    Returns comprehensive system readiness across DB, local LLM, storage, and registered tools.
    """
